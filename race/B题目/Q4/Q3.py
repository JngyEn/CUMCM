...
# ======================================================================================贝叶斯
# 定义贝叶斯更新函数
def update_defect_rate(prior_alpha, prior_beta, detected_defects, total_samples):
    return (prior_alpha + total_samples - detected_defects), (prior_beta + detected_defects)
def update_defect_rate(params,total_num):
    # 解包参数数组
